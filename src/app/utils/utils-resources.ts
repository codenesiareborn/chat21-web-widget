export const BRAND_BASE_INFO: { [key: string] : string} ={
    COMPANY_NAME: "Dit SMP",
    BRAND_NAME: "Dit SMP",
    COMPANY_SITE_NAME:"ditsmp.kemdikbud.go.id",
    COMPANY_SITE_URL:"https://ditsmp.kemdikbud.go.id",
    ...
    POWERED_BY:"<a tabindex='-1' target='_blank' ref='https://www.tiledesk.com/?utm_source=widget'><img src='https://support-pre.tiledesk.com/dashboard/assets/img/logos/tiledesk-solo_logo_new_gray.svg'/><span>Dit SMP Chat</span></a>",
}
